...
const README = [
  ...
  { Sheet: 'KPI_Status', Purpose: 'FY 2026-27 PQSCDM Goal Cascade — Plant Engg Manager (27 cols)', Required: 'Sn, KPI / Metric', Notes: 'Q1-Q4 auto = Annual Target if blank; Apr-Mar editable; YTD Avg auto; Auto values from PM/Breakdown/Energy where applicable' },
